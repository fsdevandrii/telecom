...
const CatalogMenu = () => {
  ...
  const { itemVariants, sideVariants, popapZIndex } = useMenuAnimation(
    2,
    catalogMenuIsOpen
  )
  ...
  const items = [
    ...
    },
    {
      ...
      handler: handleShowAccesoriesList,
    },
    {
  ...
  return (
    <div className='catalog-menu' style={{ zIndex: popapZIndex }}>
      <AnimatePresence>
        {catalogMenuIsOpen && (
          <motion.aside
            initial={{ width: 0 }}
                    ...
                    >
                      {!isMedia450 && (
                        <>
                          ...
                          {id === 2 && (
                            <CatalogMenuButton
                              {...buttonProps(showAccesoriesList)}
                            />
                          )}
                          {id === 3 && (
                            <CatalogMenuButton
                      ...
                      {!isMedia450 && (
                        <AnimatePresence>
                          ...
                          {isCurrentList(showAccesoriesList, 2) && (
                            <CatalogMenuList items={items} />
                          )}
